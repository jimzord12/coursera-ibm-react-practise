...
const ShoppingCart = () => {
  const dispatch = useDispatch(); // the dispatch function, required to dispatch actions
  const cartItems = useSelector((state) => state.cart.cartItems); // the state from the store
